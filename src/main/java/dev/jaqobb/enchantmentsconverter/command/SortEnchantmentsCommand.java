...
public class SortEnchantmentsCommand implements CommandExecutor {

	private EnchantmentsConverterPlugin plugin;

	public SortEnchantmentsCommand(EnchantmentsConverterPlugin plugin) {
		this.plugin = plugin;
	}
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] arguments) {
		...
		if (!player.hasPermission("enchantmentsconverter.command.sortenchantments")) {
		...
		this.plugin.sortEnchantments(player, ((Chest) block.getState()).getInventory());
		return true;
	}
}
